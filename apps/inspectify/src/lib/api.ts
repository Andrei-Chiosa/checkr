...
export namespace ce_shell {
  export type Envs =
    ...
    | { "analysis": "Minimizer", "io": { input: ce_minimizer.Input, output: ce_minimizer.Output, meta: void } }
  ...
  export type Analysis =
    ...
    | "Security"
    | "Sign";
  export const ANALYSIS: Analysis[] = ["Calculator", "Compiler", "Interpreter", "Minimizer", "Parser", "Security", "Sign"];
  export namespace io {
    export type Input = {
